...
EXPLICIT_PREREQUISITES=./amqp_0_9_1/server.exe\ ${MYDIR}/${BASENAME}.ps1\ ${MYDIR}/clients/python/${BASENAME}.py OUTPUT_DIR=$ODIR/ make ${ODIR}/amqp_0_9_1/${BASENAME}.okrun || Bail
exit
fi
