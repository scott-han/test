...
EXPLICIT_PREREQUISITES=$ODIR/amqp_0_9_1/server.exe\ ${MYDIR}/clients/php/synapse_client.php\ ${MYDIR}/clients/php/${BASENAME}.php OUTPUT_DIR=$ODIR/ CFLAGS=${CFLAGS}\ -DLAZY_LOAD_LOG_1 make ${ODIR}/amqp_0_9_1/${BASENAME}.okrun || Bail
exit
fi
