...
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_CONNECTIONOPEN_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_CONNECTIONOPEN_FRAME_H
 ...
 */
class ConnectionOpenFrame final : public ConnectionFrame
{
private:
    /**
     *  Virtual host name
...
public:
     ...
     *  Destructor
     */
    virtual ~ConnectionOpenFrame() = default;
