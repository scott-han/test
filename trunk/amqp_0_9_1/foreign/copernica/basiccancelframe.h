...
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BASIC_CANCEL_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BASIC_CANCEL_FRAME_H
 ...
 */
class BasicCancelFrame final : public BasicFrame
{
private:
    /**
...
public:
     ...
     *  Destructor
     */
    virtual ~BasicCancelFrame() = default;
