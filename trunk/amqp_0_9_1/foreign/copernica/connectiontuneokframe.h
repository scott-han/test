...
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_CONNECTIONTUNEOK_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_CONNECTIONTUNEOK_FRAME_H
 ...
 */
class ConnectionTuneOKFrame final : public ConnectionFrame
{
private:
    /**
...
public:
     ...
     *  Destructor
     */
    virtual ~ConnectionTuneOKFrame() = default;
