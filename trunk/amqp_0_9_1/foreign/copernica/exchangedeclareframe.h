...
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_EXCHANGE_DECLARE_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_EXCHANGE_DECLARE_FRAME_H
 ...
 */
class ExchangeDeclareFrame final : public ExchangeFrame
{
private:
    /**
...
public:
     ...
     *  Destructor
     */
    virtual ~ExchangeDeclareFrame() = default;
