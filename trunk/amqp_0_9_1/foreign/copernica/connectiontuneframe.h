...
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_CONNECTIONTUNE_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_CONNECTIONTUNE_FRAME_H
 ...
 */
class ConnectionTuneFrame final : public ConnectionFrame
{
private:
    /**
...
public:
     ...
     *  Destructor
     */
    virtual ~ConnectionTuneFrame() = default;
