...
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_QUEUE_DECLARE_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_QUEUE_DECLARE_FRAME_H
 ...
 */
class QueueDeclareFrame final : public QueueFrame
{
private:
    /**
...
public:
     ...
     *  Destructor
     */
    virtual ~QueueDeclareFrame() = default;
