...
//
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BASIC_QUEUE_BIND_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BASIC_QUEUE_BIND_FRAME_H
 ...
 *  Class definition
 */
class QueueBindFrame final : public QueueFrame
{
private:
    /**
     *  Deprecated field
...
public:
     ...
     *  Destructor
     */
    virtual ~QueueBindFrame() = default;
