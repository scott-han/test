#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BOOLEANSET_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BOOLEANSET_H
 ...
 *  Class definition
 */
class BooleanSet final : public Field
{
private:
    /**
     *  The actual byte
...
public:
     ...
     *  @param  that
     */
    BooleanSet(BooleanSet const &) = default;
    //{
     //   _byte = that._byte;
    //}
    ...
    bool get(uint32_t index) const
    {
        ...
        return ((1 << index) & _byte) ? true : false;
    }
