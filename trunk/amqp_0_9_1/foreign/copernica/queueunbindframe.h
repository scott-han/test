...
#ifndef DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BASIC_QUEUE_UNBIND_FRAME_H
#define DATA_PROCESSORS_SYNAPSE_AMQP_0_9_1_FOREIGN_COPERNICA_BASIC_QUEUE_UNBIND_FRAME_H
 ...
 *  Class definition
 */
class QueueUnbindFrame final : public QueueFrame
{
private:
    /**
     *  Unused field
...
public:
     ...
     *  Destructor
     */
    virtual ~QueueUnbindFrame() = default;
