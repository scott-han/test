...
void TestStreamProtocol(
  ...
  synapse::misc::mutex first_received_mutex1;
  std::atomic<bool> first_received_socket_1(true);

  synapse::misc::mutex first_received_mutex2;
  ...
  received_handler1 = [&](const boost::system::error_code& ec,
    ...
    {
      ::std::lock_guard<synapse::misc::mutex> lock_first_received1(first_received_mutex1);
  ...
  received_handler2 = [&](const boost::system::error_code& ec,
    ...
    {
      ::std::lock_guard<synapse::misc::mutex> lock_first_received2(first_received_mutex2);
