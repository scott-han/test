#ifndef UDT_CONNECTED_PROTOCOL_IO_CONNECT_OP_H_
#define UDT_CONNECTED_PROTOCOL_IO_CONNECT_OP_H_
...
/// Base class for pending fiber connect operations
...
#endif
#endif  // UDT_CONNECTED_PROTOCOL_IO_CONNECT_OP_H_
