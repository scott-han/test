...
private:
  ...
  BOOST_ASIO_DECL int do_init();
	...
	alignas(::data_processors::synapse::misc::Cache_line_size) ::CRITICAL_SECTION crit_section_;
	char Padding[(sizeof(::CRITICAL_SECTION) + static_cast<::std::size_t>(63) & ~static_cast<::std::size_t>(63)) - sizeof(::CRITICAL_SECTION)];
};
